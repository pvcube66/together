...
const CARDS: LandingCard[] = [
  {
    title: 'Focus Timer',
    description: 'Track study sessions with a beautiful Pomodoro timer. Configurable focus and break intervals.',
  ...
  {
    title: 'Smart Todo',
    description: 'Organize tasks by area, set deadlines, track weekly and monthly goals with D-Day countdown.',
    className: 'bg-blue-400 text-white',
    skeleton: <></>,
    config: { y: 62, x: 104, zIndex: 3, rotate: 6 },
  },
  {
    title: 'Study Library',
    description: 'Save YouTube lectures and playlists. Watch them in-app while your focus timer runs.',
  ...
  },
  {
    ...
    description: 'Boost concentration with curated soundscapes — ocean waves, cafe bustle, and more.',
  ...
  {
    title: 'Analytics',
    description: 'Track daily, weekly, and monthly focus hours. View streaks, rate your sessions.',
